...
* In the `db_vignette` we discuss what it means for a pair of DNA 
...
* In the `noa_vignette` we show how to calculate the distribution of the number 
of distint alleles present in a DNA mixture constituted by a abbritary number of
contributors.
...
(and until recently New Zealand and Denmark) is called AmpFlSTR SGM Plus, or 
