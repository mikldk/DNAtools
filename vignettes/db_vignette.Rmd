...
$$
  \pi^{\ell+1}_{m/p} = \left\{\renewcommand\arraystretch{1.6}\begin{array}{l<{,}!{~~~}l}
...
Applying this method to \code{db_summary} yields the *dropping ball*-picture below. 
The right end of the *distribution* is interesting part, due to the larger 
...
Both functions implements the recursions formulae of @tvedebrink2012, which enables
