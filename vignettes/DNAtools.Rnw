...
\usepackage{url,amsmath,graphicx,booktabs,array,natbib,fullpage}
\usepackage{hyperref}
%\usepackage{Sweave}
...
\bibitem[{Ghalanos and Theussl(2012)}]{Rsolnp}
...
\bibitem[{Tvedebrink \emph{et~al.}(2012)Tvedebrink, Eriksen, Curran, Mogensen, and Morling}]{tvedebrink2011}
