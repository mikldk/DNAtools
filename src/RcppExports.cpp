...
RcppExport SEXP _DNAtools_Pnm_locus(SEXP numContribSEXP, SEXP thetaSEXP, SEXP locusProbsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type numContrib(numContribSEXP);
    Rcpp::traits::input_parameter< double >::type theta(thetaSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type locusProbs(locusProbsSEXP);
    rcpp_result_gen = Rcpp::wrap(Pnm_locus(numContrib, theta, locusProbs));
    return rcpp_result_gen;
END_RCPP
}
// Pnm_all_cpp
